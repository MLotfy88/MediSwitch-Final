...
*   **6.4. تطبيق الأصول الجديدة:**
    *   `[~]` 6.4.1. استخدام الأيقونات الجديدة من التصميم (لم يتم العثور على أيقونات مخصصة، نستخدم Material Icons حالياً).
    *   `[~]` 6.4.2. استخدام الصور التوضيحية الجديدة (إن وجدت) (لم يتم العثور على صور توضيحية مخصصة).
