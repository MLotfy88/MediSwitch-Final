...
*   `[~]` **3.3. شاشة حاسبة الجرعة (`weight_calculator_screen.dart`):** (تم تحديث التصميم الأساسي، يحتاج لتحسين اختيار الدواء - انظر المرحلة 6).
...
*   `[~]` **3.5. شاشة مدقق التفاعلات (`InteractionCheckerScreen`):** (تم تحديث التصميم الأساسي، يحتاج لتحسين اختيار الدواء وعرض النتائج - انظر المرحلة 6).
    ...
    *   `[~]` 3.5.5. بناء واجهة المستخدم. (تحتاج مراجعة وتطبيق تصميم المرحلة 6)
