...
# -*- coding: utf-8 -*-
"""
قراءة شاملة للسجلات 2000-4000 من بيانات OpenFDA
"""
import json
...
print(f'📖 سنقرأ السجلات من 2000 إلى 4000...\n')
print('='*120)
...
# Comprehensive reading of records 2000-4000
sample_display = []
for i, record in enumerate(results[2000:4000], start=2000):
    ...
    # Save interesting samples (first 20 with pharmaceutical-like content)
    if len(sample_display) < 20:
        # Look for pharmaceutical keywords in dosage text
        if dosage_admin:
...
print(f'\n📈 إحصائيات شاملة للسجلات 2000-4000 ({stats["total_examined"]} سجل):\n')
...
print(f'\n\n{"="*120}')
print(f'🔍 عينة من السجلات الصيدلانية (أول 20 سجل):')
print(f'{"="*120}\n')
...
print(f'\n\n✅ تم الانتهاء من قراءة وتحليل السجلات 2000-4000')
